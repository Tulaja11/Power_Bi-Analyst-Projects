...
| File | What it does |
|------|--------------|
| `Students_Performance_Dataset_10k.csv` | Raw dataset (10k records) |
| `stud_proj.sql` | SQL queries — EDA, at-risk identification, score breakdowns |
| `Stud_performance.ipynb` | Python notebook — data cleaning, ML model, predictions |
| `Student_analysis.pbix` | Power BI dashboard for visual exploration |
...
- Grade and pass/fail distribution
